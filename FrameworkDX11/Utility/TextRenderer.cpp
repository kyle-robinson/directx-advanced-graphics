...
TextRenderer* TextRenderer::m_pTextRendererInstance{ nullptr };
std::mutex TextRenderer::m_mutex;

TextRenderer* TextRenderer::GetInstance()
{
	std::lock_guard<std::mutex> lock( m_mutex );
	if ( m_pTextRendererInstance == nullptr )
	{
		m_pTextRendererInstance = new TextRenderer();
	}

	return m_pTextRendererInstance;
}
